//
//  WDQRCodeCardViewController.swift
//  WeiDo
//
...
class WDQRCodeCardViewController: UIViewController {
    ...
    private func creatQRCodeImage() -> UIImage{
        ...
        // 3.设置需要生成二维码的数据
        filter!.setValue("卢良潇".dataUsingEncoding(NSUTF8StringEncoding), forKey: "inputMessage")
        ...
        // 5.创建一个头像
        let icon = UIImage(named: "greenAvatar_default")
